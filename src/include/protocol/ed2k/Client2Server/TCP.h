...
enum OP_ClientToServerTCP
{
	...
	OP_CALLBACKREQUEST = 0x1C, // <ID 4>
				   //	OP_QUERY_CHATS				= 0x1D,	// (deprecated, not
				   // supported by server any
	// longer) 	OP_CHAT_MESSAGE				= 0x1E,	// (deprecated, not supported by
	// server any longer) 	OP_JOIN_ROOM				= 0x1F,	// (deprecated, not supported
	// by server any longer)
	...
	// longer) 	OP_CHAT_USER_JOIN			= 0x3B,	// (deprecated, not supported by
	// server any longer) 	OP_CHAT_USER_LEAVE			= 0x3C,	// (deprecated, not supported
	// by server any longer) 	OP_CHAT_USER				= 0x3D,	// (deprecated, not
	// supported by server any longer)
